...
public class SimpleLayout {
    ...
    public class BasePane extends JPanel {
        ...
        InvoicePanel test=new InvoicePanel();
        JInternalFrame testFrame=new JInternalFrame("Invoice",true,true,true,true);

        public BasePane() {
            setLayout(new BorderLayout());
            testFrame.add(test);
            testFrame.setVisible(true);
            testFrame.setBounds(50,50,500,500);
            desktopPane = new JDesktopPane();
            //desktopPane.setOpaque(true);
            desktopPane.add(testFrame,new Integer(1));
